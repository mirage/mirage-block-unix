(* OASIS_START *)
(* DO NOT EDIT (digest: ed7c381fb2bfd68c15d0c14cfa97a716) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("mirage_block_unix", ["lib"], [])];
     lib_c = [("mirage_block_unix", "lib", [])];
     flags =
       [
          (["oasis_library_mirage_block_unix_ccopt"; "compile"],
            [
               (OASISExpr.EBool true,
                 S [A "-ccopt"; A "-I"; A "-ccopt"; A "${pkg_lwt}"])
            ])
       ];
