...
(* OASIS_START *)
(* DO NOT EDIT (digest: 48b616e2aaea6ed30d77b6fb26bcf82e) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_ccopt =
                        [(OASISExpr.EBool true, ["-I"; "${pkg_lwt}"])];
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "mirage-block-unix";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           InternalLibrary "mirage_block_unix";
                   ...
                   {exec_custom = true; exec_main_is = "benchmark.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "a\1730\214\140\169&\128\189!\030\193\011>\212V";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
